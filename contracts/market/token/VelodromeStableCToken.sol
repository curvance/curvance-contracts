...
contract VelodromeStableCToken is StrategyCToken {
    /// TYPES ///
    ...
    error VelodromeStableCToken__InvalidAssetType();
    ...
    constructor(
        ...
        if (gauge.stakingToken() != _asset) {
            revert VelodromeStableCToken__InvalidAssetType();
        }
    ...
    function harvest(
        ...
        if (_checkVestingFinished(_vestingData)) {
            ...
            (r0, r1) = sd.token0 == IVeloPair(_asset).token0()
                ? (r0, r1)
                : (r1, r0);
