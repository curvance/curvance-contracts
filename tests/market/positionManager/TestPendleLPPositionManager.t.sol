...
//         marketManagerIsolated.listTokens(address(pSTETH), address(borrowableCDAI));
...
//         pSTETH.setDelegateApproval(address(positionManager), true);
...
//         pSTETH.approve(address(positionManager), type(uint256).max);
