...
contract TestDualSidedVaultPositionManager is TestBaseMarketIsolated {
    ...
    function testLeverageWithSwap() public {
        ...
        _assertDualSidedPositionManagerHasNoResidue();
    ...
    function testDeleverageWithSwap() public {
        ...
        uint256 fraxFromRedeem =
            IVault(_SFRAX_ADDRESS).previewRedeem(sFraxToRedeem);
        ...
        deleverageAction.swapActions[0].inputAmount = fraxFromRedeem;
        deleverageAction.swapActions[0].outputToken = address(usdc);
        deleverageAction.swapActions[0].target = _UNISWAP_V3_SWAP_ROUTER;

        IUniswapV3Router.ExactInputParams memory params;
        params.path =
            abi.encodePacked(_FRAX_ADDRESS, uint24(500), address(usdc));
        params.recipient = address(positionManager);
        params.deadline = block.timestamp + 1 hours;
        params.amountIn = fraxFromRedeem;
        params.amountOutMinimum = 0;
    ...
    function testDeleverageWithSwap_fail_InsufficientRepayRollsBack() public {
        _setUpMarketWithSwap();
        ...
        uint256 marketCollateralBefore = simpleCSFRAX.marketCollateralPosted();
        ...
        assertEq(simpleCSFRAX.marketCollateralPosted(), marketCollateralBefore);
        _assertDualSidedPositionManagerHasNoResidue();
    ...
    function testLeverageNoSwap() public {
        ...
        uint256 amountForLeverage =
            _maxRemainingLeverageOfHelper(user1, address(borrowableCFRAX)) / 2;
    ...
    function _assertDualSidedPositionManagerHasNoResidue() internal view {
        ...
        if (address(borrowableCFRAX) != address(0)) {
            assertEq(
