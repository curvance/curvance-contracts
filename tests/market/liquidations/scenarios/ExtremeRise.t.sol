...
contract ExtremeRiseTest is TestBaseLiquidations {
    ...
    function testLiquidateWithExtremeRise() public {

        // set USDC price to $1 million each
        mockUsdcFeed.setMockAnswer(1e8 * 1_000_000);
    ...
    function testLiquidateWithDebtRiseBy90Percent() public {

        // set USDC price to $190 each (90% rise)
        mockUsdcFeed.setMockAnswer((1e8 * 190) / 100);
    ...
    function testLiquidateWithDebtRiseBy99Percent() public {

        // set USDC price to $199 each (99% rise)
        mockUsdcFeed.setMockAnswer((1e8 * 199) / 100);
