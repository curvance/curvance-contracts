...
contract Test_SwapPositionManagementPendlePT is TestBaseMarketIsolated {
    ...
    function testDeLeverageWithPostSwap_Success() public {
        ...
        deleverageData.swapData[0].inputAmount = 0.85 ether;
        ...
        deleverageData.repayAmount = (eDAIBorrowedBefore * 95) / 100;
