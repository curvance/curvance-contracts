...
contract ResetAuctionParametersTest is TestBaseMarketIsolated {
    ...
    function test_resetAuctionParameters_fail_whenUnauthorized() public {
        vm.startPrank(user1);
    ...
    function test_resetAuctionParameters_success() public {
