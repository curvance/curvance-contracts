...
contract TestMulticallWithPythAdaptor is TestBaseMarket {
    ...
    function setUp() public override {
        ...
        adapter.updateFeedsWithETH{ value: 1 ether }(priceUpdateData);
        ...
        multicallProviders[1] = address(cWBTC);
    ...
    function testCheckCallData() public {
        ...
        vm.expectRevert(
            MulticallDataCheckerBase.MulticallDataChecker__TargetError.selector
        );
        ...
        vm.expectRevert(
            MulticallDataCheckerBase
                .MulticallDataChecker__InvalidCallData
                .selector
        );
        multicallDataChecker.checkCallData(
            address(this),
        ...
        multicallDataChecker.checkCallData(
            ...
            address(adapter),
            abi.encodeWithSelector(
                PythAdaptor.updateFeedsWithETH.selector,
                priceUpdateData
            )
        );
    }
