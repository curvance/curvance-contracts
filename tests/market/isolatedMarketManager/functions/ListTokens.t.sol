...
contract ListTokens is TestBaseMarketManagerIsolated {
    ...
    function testListTokens() public {
        ...
        assertFalse(marketManagerIsolated.isListed(address(simpleCBALRETH)));
