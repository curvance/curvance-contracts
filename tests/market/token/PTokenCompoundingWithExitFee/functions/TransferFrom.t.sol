...
contract PTokenCompoundingWithExitFeeTransferFromTest is
    TestBasePTokenCompoundingWithExitFee
{
    ...
    function test_pTokenCompoundingWithExitFeeTransferFrom_fail_whenTransferZeroAmount()
        public
    {
    ...
    function test_pTokenCompoundingWithExitFeeTransferFrom_fail_whenAllowanceIsInvalid()
        public
    {
        vm.expectRevert();
    ...
    function test_pTokenCompoundingWithExitFeeTransferFrom_fail_whenTransferIsNotAllowed()
        public
    {
    ...
    function test_pTokenCompoundingWithExitFeeTransferFrom_success() public {
