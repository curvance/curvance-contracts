...
contract PostCollateralTest is TestBaseBorrowableCToken {
    ...
    function test_borrowableCTokenCollateralize_fail_whenZeroAmount() public {
        vm.expectRevert(BaseCToken.BaseCToken__ZeroAmount.selector);

        _postBorrowableCUSDCCollateral(0);
    }

    function test_borrowableCTokenCollateralize_fail_whenCollateralAmountExceedsCTokens() public {
        vm.expectRevert(
    ...
    function test_borrowableCTokenCollateralize_fail_whenCollateralAmountExceedsCollateralCap() public {
    ...
    function test_borrowableCTokenCollateralize_success() public {
