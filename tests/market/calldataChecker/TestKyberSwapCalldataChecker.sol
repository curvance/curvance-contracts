...
contract TestKyberSwapCalldataChecker is TestBaseMarketIsolated {
    ...
    address public legacyKyberSwapExecutor =
    ...
    function setUp() public override {
        ...
        address[] memory kyberSwapExecutors = new address[](2);
        kyberSwapExecutors[0] = kyberSwapExecutor;
        kyberSwapExecutors[1] = legacyKyberSwapExecutor;
    ...
    function test_recipientZero_resolvesToMsgSender() public {
        ...
        desc.srcAmounts[0] = _sourceAmountAfterFee(5e6);
    ...
    function test_revert_src_multipleReceivers() public {
        recipient = address(this);
        swapAction.inputToken = _USDC_ADDRESS;
        swapAction.inputAmount = 5e6;
        swapAction.outputToken = WMON_ADDRESS;
    ...
    function test_revert_src_receiverNotExecutor() public {
        recipient = address(this);
        swapAction.inputToken = _USDC_ADDRESS;
        swapAction.inputAmount = 5e6;
        swapAction.outputToken = WMON_ADDRESS;
        swapAction.target = kyberSwapRouter;
        swapAction.call = _buildKyberCalldataWithSrcConfig(
            makeAddr("attacker"),
            5e6,
            _sourceAmountAfterFee(5e6),
            recipient
        );
    ...
    function test_revert_src_amountWithoutFee() public {
        recipient = address(this);
        swapAction.inputToken = _USDC_ADDRESS;
        swapAction.inputAmount = 5e6;
        swapAction.outputToken = WMON_ADDRESS;
    ...
    function test_src_amountAcceptsFeeFloorRounding() public {
        recipient = address(this);
        swapAction.inputToken = _USDC_ADDRESS;
        swapAction.inputAmount = 5_002_499;
        swapAction.outputToken = WMON_ADDRESS;
        swapAction.target = kyberSwapRouter;
        swapAction.call = _buildKyberCalldataWithSrcConfig(
            kyberSwapExecutor,
    ...
    function test_revert_src_amountRejectsFeeCeilRounding() public {
        recipient = address(this);
        swapAction.inputToken = _USDC_ADDRESS;
        swapAction.inputAmount = 5_002_499;
        swapAction.outputToken = WMON_ADDRESS;
    ...
    /// @dev Calldata from KyberSwap API captured 2026-06-02 20:29:40 UTC
    ///      across Monad blocks 78709474-78709476. amount=5_002_001,
    ///      feeAmount=4, isInBps=true, chargeFeeBy=currency_in,
    ///      feeReceiver=DAO. The API route floors the fee to 2_000
    ///      and sets srcAmounts[0] = 5_000_001 with real targetData.
    function test_api_src_amountAcceptsFeeFloorRoundedRouteLowerEdge() public {
        swapAction.inputToken = _USDC_ADDRESS;
        swapAction.inputAmount = 5_002_001;
        swapAction.outputToken = WMON_ADDRESS;
        swapAction.target = kyberSwapRouter;
        swapAction
            .call = hex"";

        uint256 minOut = checker.checkCalldata(swapAction, address(this));
        assertEq(minOut, 241517939102164625652);
    }

    /// @dev Calldata from KyberSwap API captured 2026-06-02 20:20:11 UTC
    ///      across Monad blocks 78708051-78708053. amount=5_002_499,
    ///      feeAmount=4, isInBps=true, chargeFeeBy=currency_in,
    ///      feeReceiver=DAO. The API route floors the fee to 2_000
    ///      and sets srcAmounts[0] = 5_000_499 with real targetData.
    function test_api_src_amountAcceptsFeeFloorRoundedRoute() public {
        swapAction.inputToken = _USDC_ADDRESS;
        swapAction.inputAmount = 5_002_499;
        swapAction.outputToken = WMON_ADDRESS;
        swapAction.target = kyberSwapRouter;
        swapAction
            .call = hex"";

        uint256 minOut = checker.checkCalldata(swapAction, address(this));
        assertEq(minOut, 240040661168145425693);
    }
    ...
    function test_integration_zapperSwap() public {
        ...
        uint256 daoUSDCBalanceBefore =
            IERC20(_USDC_ADDRESS).balanceOf(daoAddress);
        ...
        uint256 expectedCallerUSDCBalance =
            daoAddress == address(this) ? 2_000 : 0;
        uint256 expectedDaoUSDCBalance =
            daoAddress == address(this) ? 2_000 : daoUSDCBalanceBefore + 2_000;
        assertEq(
            IERC20(_USDC_ADDRESS).balanceOf(address(this)),
            expectedCallerUSDCBalance,
            "runtime swap MUST consume caller input except DAO fee overlap"
        );
        assertEq(
            IERC20(_USDC_ADDRESS).balanceOf(daoAddress),
            expectedDaoUSDCBalance,
            "runtime swap MUST pay input-side DAO fee"
        );
        assertEq(
            IERC20(_USDC_ADDRESS).balanceOf(address(simpleZapper)),
            0,
            "zapper MUST not retain source token"
        );

        deal(_USDC_ADDRESS, address(this), 5e6);
        centralRegistry.setExternalCalldataChecker(
            kyberSwapRouter,
            address(new MockCalldataChecker(kyberSwapRouter))
        );
        swapAction.call = _withSingleSrcAmount(swapAction.call, 5e6);
        uint256 cWMONBalanceBeforeMalformed =
            borrowableCWMON.balanceOf(address(this));
        ...
        assertEq(
            IERC20(_USDC_ADDRESS).balanceOf(address(this)),
            5e6,
            "malformed runtime route MUST roll back user input"
        );
        assertEq(
            borrowableCWMON.balanceOf(address(this)),
            cWMONBalanceBeforeMalformed,
            "malformed runtime route MUST not mint shares"
        );
    }
    ...
    function _sourceAmountAfterFee(uint256 amount) internal pure returns (uint256) {
        return amount - ((amount * 4) / 10_000);
    }

    function _withSingleSrcAmount(
        ...
        IMetaAggregationRouterV2.SwapExecutionParams memory exec =
            abi.decode(params, (IMetaAggregationRouterV2.SwapExecutionParams));
        exec.desc.srcAmounts[0] = srcAmount;

        return abi.encodeWithSelector(IMetaAggregationRouterV2.swap.selector, exec);
    }

    function _buildKyberCalldataWithSrcConfig(
        address srcReceiver,
        uint256 amount,
        uint256 srcAmount,
        address dstReceiver
        ...
        desc.feeAmounts[0] = 4;
        desc.srcReceivers = new address[](1);
        desc.srcReceivers[0] = srcReceiver;
        desc.srcAmounts = new uint256[](1);
        desc.srcAmounts[0] = srcAmount;
    ...
    function _buildKyberCalldataWithFee(
        ...
        desc.srcReceivers[0] = kyberSwapExecutor;
        desc.srcAmounts = new uint256[](1);
        desc.srcAmounts[0] = _sourceAmountAfterFee(amount);
