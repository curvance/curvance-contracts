...
contract TestVariables {
    ...
    mapping(uint256 => AuraCToken) public cBALRETHs;
    mapping(uint256 => MockAuraCTokenWithExitFee) public cBALRETHWithExitFees;
    ...
    function _initMainContractVariables() internal {
        ...
        dDAI = dDAIs[chainId];
        cBALRETH = cBALRETHs[chainId];
        cBALRETHWithExitFee = cBALRETHWithExitFees[chainId];
