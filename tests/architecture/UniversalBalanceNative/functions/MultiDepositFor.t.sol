    ...
    TestBaseUniversalBalanceNative
{
    ...
    function test_universalBalanceNativeMultiDepositFor_fail_whenLengthsAreMismatch(
    ...
    function test_universalBalanceNativeMultiDepositFor_fail_whenRecipientIsNotApproved(
        uint256[3] memory amounts_,
        bool[3] memory willLend_
    ) public setupVariables(amounts_, willLend_) {
        _prepareWETH(user1, depositSum);
    ...
    function test_universalBalanceNativeMultiDepositFor_fail_whenHasNoEnoughWETH_fuzzed(
        uint256[3] memory amounts_,
        bool[3] memory willLend_
    ) public setupVariables(amounts_, willLend_) {
        _prepareWETH(user1, depositSum);
        ...
        weth.approve(address(universalBalanceNative), depositSum + 1);
    ...
    function test_universalBalanceNativeMultiDepositFor_fail_whenExceedsAllowance_fuzzed(
        uint256[3] memory amounts_,
        bool[3] memory willLend_
    ) public setupVariables(amounts_, willLend_) {
    ...
    function test_universalBalanceNativeMultiDepositFor_fail_whenTokenIsNotListed(
        uint256[3] memory amounts_,
        bool[3] memory willLend_
    ) public setupVariables(amounts_, willLend_) {
        _prepareWETH(user1, depositSum);
    ...
    function test_universalBalanceNativeMultiDepositFor_fail_whenAmountIsZero(
        uint256[3] memory amounts_,
        bool[3] memory willLend_
    ) public setupVariables(amounts_, willLend_) {
        _prepareWETH(user1, depositSum);
    ...
    function test_universalBalanceNativeMultiDepositFor_fail_whenSumIsInvalid(
        uint256[3] memory amounts_,
        bool[3] memory willLend_
    ) public setupVariables(amounts_, willLend_) {
        _prepareWETH(user1, depositSum);
    ...
    function test_universalBalanceNativeMultiDepositFor_success_fuzzed(
