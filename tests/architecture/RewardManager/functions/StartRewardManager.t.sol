...
contract StartRewardManagerTest is TestBaseRewardManager {
    ...
    function test_startRewardManager_fail_whenRewardManagerIsAlreadyStarted() public {
        rewardManager.startRewardManager();

        vm.expectRevert(RewardManager.RewardManager__RewardManagerIsAlreadyStarted.selector);
        rewardManager.startRewardManager();
    }
